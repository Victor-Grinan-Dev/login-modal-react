import "./App.css";
import water from "./images/image.jpg";
...
function App() {
  return (
    <div class="global-container flex items-center justify-center min-h-screen bg-rose-50">
      <div className="card-container relative flex flex-col bg-white m-6 space-y-10 rounded-3xl shadow-2xl md:flex-row md:space-y-0 md:m-0 ">
        <div className="left-side p-6 md:p-20">
          ...
          <div className="flex flex-col items-center justify-between mt-6 space-y-6 md:flex-row md:space-y-0">
            ...
            <button className="w-full md:w-auto flex justify-center items-center p-6 space-x-4 font-sans font-bold text-white rounded-md shadow-sm px-9 bg-cyan-700 shadow-cyan-100 hover:bg-opacity-90 hover:shadow-lg border transition hover:-translate-y-0.5 duration-150">
              <span>Next</span>
              <svg
        ...
        <img src={water} alt="water" className="w-[430px] hidden md:block" />
        <div
